...
function nuevoUsuario(nombre, email, password) {
  ...
  // Devuelve el objeto
  // Tu código:
 /*const objNombre=nombre;
 const objEmail=email;
 const objPassword=password;
...
function tienePropiedad(objeto, propiedad) {
  ...
  if(objeto.property) return true;
  return false;*/
...
function verificarPassword(usuario, password) {
  ...
  if(usuario.password == checkPass) return true;
  return false;*/
